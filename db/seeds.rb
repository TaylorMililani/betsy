...
Product.create([{name: "Frida Kalo", description: "Artistic and creative artist", price: 500, in_stock: 10, user_id: 1}, {name: "Salvador Dali", description: "Surrealistic painter", price: 1000, in_stock: 3, user_id: 2}, {name: "Andy Warhol", description: "The Prince of Pop", price: 200, in_stock: 9, user_id: 2}, {name: "Flash", description: "Superfast person", price: 120, in_stock: 20, user_id: 2}, {name: "Superman", description: "Various superhuman abilities, such as incredible strength and impervious skin.", price: 500, in_stock: 3, user_id: 1}, {name: "Wonder woman", description: "powerful, strong-willed character who does not back down from a fight or a challenge.", price: 3000, in_stock: 10, user_id: 2}])

products = Product.create([{name: "Marie Curie", description: "Not great at chemistry? Get Marie Curie's brain for science!", price: 22000, in_stock: 10, user_id: 1}, {name: "Ada Lovelace", description: "get some mad coding skills from none other than the mother of programming!", price: 28000, in_stock: 3, user_id: 2}, {name: "Grace Hopper", description: "Get computer science skills and toughness from a pioneer of the field, Grace Hopper!", price: 30000, in_stock: 9, user_id: 1}, {name: "Gloria Steinem", description: "Get the gumption of feminist hero, Gloria Steinem!", price: 23000, in_stock: 20, user_id: 2}, {name: "Marsha P. Johnson", description: "Get the style, bravery, attitude, and all-around bad-assery of lgbtq+ rights activist, Marsha P. Johnson!", price: 50000, in_stock: 8, user_id: 1}, {name: "Rosa Parks", description: "Get the strength, courage, and determination of legendary civil rights activist, Rosa Parks! Bonus item: her bus ticket!", price: 40000, in_stock: 10, user_id: 2}])
